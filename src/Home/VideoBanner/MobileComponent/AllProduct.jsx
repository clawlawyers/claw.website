    ...
    <div className=" flex items-center mt-8 justify-center ">
      <div className="w-[80%] grid grid-cols-3 sm:grid-cols-2 items-center gap-6 md:grid-cols-3 lg:grid-cols-5 ">
        ...
        <div
          ...
          className="bg-[rgba(0,128,128,0.2)] border-2 sm:mx-1 ml-12 border-green-400 hover:scale-95 cursor-pointer transition-all duration-300 text-green-400 rounded-lg flex flex-col items-center justify-center  sm:pt-6 shadow-lg w-[100px] h-[110px]  sm:w-52 sm:h-52">
          <img
            src={CasePrediction}
