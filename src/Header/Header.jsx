            ...
            <div className={Styles.headerContent}>
                ...
                >
                    <div style={{ display: "flex", justifyContent: "flex-end", padding: "10px 10px 0px 0px" }}>
                        <button style={{ backgroundColor: "inherit", border: "none", color: "white" }} onClick={() => setNavOpen(false)}>
                    ...
                    <List>
                        {navLinks.map(({ path, label, icon: Icon }, index) => (
                            <ListItem key={path} disablePadding>
                                <ListItemButton onClick={() => { navigate(path); setNavOpen(false) }}>
                                    <ListItemIcon>
                        ...
                        <ListItem key={"auth"} disablePadding>
                            <ListItemButton onClick={() => { handleAuthChange(); setNavOpen(false) }}>
                                <ListItemIcon>
                                    <PersonIcon style={{ color: "white" }} />
                                </ListItemIcon>
                                <ListItemText primary={!isAuthLoading && (currentUser ? "Logout" : "Login")} />
