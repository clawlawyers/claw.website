    ...
    return (
        <div style={{ width: "60%", margin: "auto", display: "flex", flexDirection: "column", alignItems: "start", color: "white" }}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to CLaw, accessible from <a href="https://www.clawlaw.in/" rel="external nofollow noopener" target="_blank">https://www.clawlaw.in/</a></p>
                </li>
                <li>
