...
export function CaseCard({ name, date, court, citations, messageId }) {
    return (
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 10, alignItems: "center", padding: 16, backgroundColor: "#8940FF", borderRadius: 10 }}>
            ...
            <Link to={`/case/search?id=${messageId}`} style={{ border: "none", padding: "12px 16px", minWidth: 'fit-content', backgroundColor: "white", borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: "none", color: "black" }}>View document</Link>
