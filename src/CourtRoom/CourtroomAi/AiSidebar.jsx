  ...
  return (
    <>
      <div className="flex flex-col gap-2 h-full p-3">
        {/* top container */}
        <div className="bg-[#008080] p-4 border-2 border-white rounded h-1/3 gap-5 flex flex-col justify-between">
        ...
        {/* bottom container */}
        <div className="bg-[#008080] p-4 h-2/3 border-2 border-white rounded flex flex-col justify-between">
          <div>
            <motion.div
              whileTap={{ scale: "0.95" }}
