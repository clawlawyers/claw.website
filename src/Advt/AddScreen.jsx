...
const AddScreen = () => {
  ...
  return (
    <div className="h-screen w-[95%] m-auto flex flex-col justify-between">
      <div className=" grid md:grid-cols-2 items-center justify-center pt-3 gap-2">
      ...
      <div className=" grid md:grid-cols-2 items-center justify-center">
        ...
        <div className="m-auto w-full flex items-center justify-center">
          <button
            ...
            className="w-1/2 rounded-full bg-white bg-opacity-10 uppercase"
          >
            Subscribe Now
          </button>
        </div>
      ...
      <Modal open={paymentDialog} onClose={() => setPaymentDialog(false)}>
        <div
          ...
          className="w-[80%] md:w-[40%]  bg-white "
          style={{
            position: "absolute",
            top: "50%",
            left: "50%",
        ...
        >
          ...
          <div className="flex flex-col mt-4">
            <input
              type="number"
              className="text-black focus:outline-none border-2 border-black rounded-lg p-3"
          ...
          <div onClick={loadRazorpay} className="mt-2 flex justify-center">
            <button className="rounded-lg">Proceed To Payment</button>
          </div>
        </div>
      </Modal>
    </div>
